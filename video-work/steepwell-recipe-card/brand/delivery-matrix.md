...
`## Delivery` line in `motion-brand.md`. Use this when you ship one master to more than
one place. Declare a piece's destinations at treatment (stage 1); QC every declared
variant at QC (stage 6). Author the master once — always the widest aspect,
...
|---|---|---|---|---|---|---|
| social feed — square (primary) | 1:1 1080×1080 | ≤60s (teases 10–20s) | autoplay MUTED — assume never heard; must read with sound off | mandatory where words carry; hook readable in 2s | ≤10 MB | subtle paper grain OK |
